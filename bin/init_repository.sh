...
gh secret set DOCKER_PASSWORD --body "dckr_pat_UTM-B3IhkXV5BzLiIzSEHHXwBd4" --env "$environmentName"
gh secret set DOCKER_USERNAME --body "mouadsadik" --env "$environmentName"
